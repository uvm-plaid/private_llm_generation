...
def parse_args():
    ...
    parser.add_argument("--save_size", type=int, default=100)
...
if __name__ == "__main__":
    ...
    # we unload con_wrapper then load con_filter to filter the accumulated `y_summ`s, then save them into file.
    ########
