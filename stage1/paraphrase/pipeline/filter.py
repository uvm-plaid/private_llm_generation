...
class ConFilter:
    def __init__(self, args: Namespace):
        ...
        self.nli_tokenizer = AutoTokenizer.from_pretrained(nli_model_name, use_fast=False)
        ...
        self.reverse_nli_threshold = 0.9
    ...
    def filter_length(self, pair: Pair) -> bool:
        ...
        return min_length <= len(pair.y_summ) <= max_length # REPLACED y_new with y_summ
    ...
    def filter_number(self, pairs: List[Pair]) -> List[Pair]:
        ...
        for pair in pairs:
            ...
            y_summ_numbers = self.numerize(pair.y_summ)  # REPLACED y_new with y_summ
