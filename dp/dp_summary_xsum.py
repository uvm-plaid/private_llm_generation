...
def main(args):
    wandb.init(project="XSum_Summarization", entity="ivolinengong", name=args.run_name)
    ...
    tokenized_train_dataset = dataset.map(lambda x: preprocess_function(x, tokenizer, args.max_input_length, args.max_output_length), batched=True)
