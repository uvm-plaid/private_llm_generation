...
class ConGenerator:
    ...
    def init_tokenizer_and_model(self) -> Tuple[PreTrainedTokenizer, PreTrainedModel]:
        ...
        model_path = f"/users/k/n/kngongiv/Research/clean/private_llm_generation/stage_dp/models/{model_name}"
        
        # model_path = f"/users/k/n/kngongiv/Research/clean/private_llm_generation/dialog/stage_dp/models/{model_name}"
        # model_path = f"/users/k/n/kngongiv/Research/clean/private_llm_generation/dialog/dp/models/{model_name}"

        # Non-DP Impossible Model
        # model_path = f"/users/k/n/kngongiv/Research/private_llm_generation/dialog/stage1/train/gen_model/{model_name}"
        
        # model_path = f"/users/k/n/kngongiv/Research/private_llm_generation/dialog/dp/{model_name}"
    ...
    def qualifies_as_y_con(self, text: str) -> bool:
        ...
        if self.args.domain in ["news", "news-human"]:
            ...
            no_format_markers = not bool(re.search(r'[-_]{2,}', text))
            no_nonstandard_chars = '\ufffd' not in text
            out = default and no_link and no_edit and no_format_markers and no_nonstandard_chars
