...
def parse_args():
    ...
    args.train_filename = f"/users/k/n/kngongiv/Research/private_llm_generation/dialog/stage2/train/data/processed/{args.model_name}/train.jsonl"
    args.valid_filename = f"/users/k/n/kngongiv/Research/private_llm_generation/dialog/stage2/train/data/processed/{args.model_name}/valid.jsonl"
...
def init_tokenizer_and_model(args: Namespace) -> Tuple[PreTrainedTokenizerFast, PreTrainedModel]:
    ...
    model_path = f"/users/k/n/kngongiv/Research/private_llm_generation/dialog/stage_dp/models/{model_name}"
